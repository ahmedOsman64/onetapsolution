...
const AdminLayout = () => {
    ...
    return (
        <div className="min-h-screen bg-[#050608] text-slate-200 selection:bg-[#04C244]/30 selection:text-white">
            {/* Sidebar */}
            ...
            <div className="md:ml-64 flex flex-col min-h-screen transition-all duration-300">
                ...
                <footer className="px-8 py-6 border-t border-white/5 text-center md:text-left">
