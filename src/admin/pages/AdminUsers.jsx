            ...
            <div className="bg-[#0A0C10] border border-white/5 rounded-[32px] overflow-hidden">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full border-collapse">
                        <thead>
                            <tr className="text-left border-b border-white/5 text-[10px] font-bold uppercase tracking-widest text-slate-500">
                                ...
                                >
                                    <td className="px-8 py-5">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="text-sm font-bold text-white group-hover:text-[#04C244] transition-colors">{u.name}</p>
                                    ...
                                    <td className="px-8 py-5 text-right">
                                        <div className="flex items-center justify-end gap-2">
                                            <button 
                                                ...
                                                className="p-2 bg-white/5 rounded-lg text-slate-400 hover:text-[#04C244] hover:bg-[#04C244]/10 transition-all"
                                            >
                                                <Edit2 size={16} />
                                            </button>
                                            <button 
                ...
                {isModalOpen && (
                    <div className="fixed inset-0 z-100 flex items-center justify-center p-6">
                        ...
                        <motion.div 
                            ...
                            className="bg-[#0A0C10] border border-white/10 rounded-[32px] w-full max-w-lg max-h-[90vh] overflow-hidden relative z-10 shadow-2xl flex flex-col"
                        >
                            <div className="p-8 border-b border-white/5 flex items-center justify-between shrink-0">
                                <h2 className="text-xl font-bold text-white">{editingUser ? 'Edit System User' : 'Create New User'}</h2>
                                            ...
                                            <div className="flex items-center gap-2 p-1 bg-white/5 border border-white/10 rounded-2xl">
                                                {['Active', 'Offline'].map((status) => (
                                                    <button
                                                        ...
                                                        className={`flex-1 py-2 text-[10px] font-bold uppercase rounded-xl transition-all ${formData.status === status ? 'bg-[#04C244] text-black' : 'text-slate-500 hover:text-white'}`}
                                                    >
                                                        {status}
                                                    </button>
                                                ))}
